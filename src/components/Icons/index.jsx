...
const LikeIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 33 37.546" >
    <g id="like" transform="translate(0)">
      ...
      <path id="Path_156" data-name="Path 156" className="cls-1" d="M340.664,35.716l-1.556,1.556a1.1,1.1,0,0,0,1.556,1.556l1.555-1.556a1.1,1.1,0,1,0-1.555-1.556Zm0,0" transform="translate(-313.942 -32.798)" />
      <path id="Path_157" data-name="Path 157" className="cls-1" d="M180.323,35.716a1.1,1.1,0,0,0,0,1.556l1.555,1.556a1.1,1.1,0,1,0,1.556-1.556l-1.556-1.556A1.1,1.1,0,0,0,180.323,35.716Zm0,0" transform="translate(-166.801 -32.798)" />
    </g>
  </svg>
);
...
const TelephoneIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 28 28">
    <g id="telephone-call" transform="translate(-2 -2)">
      <path id="Path_158" data-name="Path 158" class="cls-1" d="M29.393,23.36c-.874-.733-6-3.979-6.852-3.83-.4.071-.706.412-1.525,1.389a11.687,11.687,0,0,1-1.244,1.347,10.757,10.757,0,0,1-2.374-.88A14.7,14.7,0,0,1,10.614,14.6a10.757,10.757,0,0,1-.88-2.374,11.687,11.687,0,0,1,1.347-1.244c.976-.819,1.318-1.123,1.389-1.525.149-.854-3.1-5.978-3.83-6.852C8.334,2.243,8.056,2,7.7,2,6.668,2,2,7.772,2,8.52c0,.061.1,6.07,7.689,13.791C17.41,29.9,23.419,30,23.48,30c.748,0,6.52-4.668,6.52-5.7,0-.356-.243-.634-.607-.94Z" />
      <path id="Path_159" data-name="Path 159" class="cls-1" d="M23,15h2a8.009,8.009,0,0,0-8-8V9a6.006,6.006,0,0,1,6,6Z" />
      <path id="Path_160" data-name="Path 160" class="cls-1" d="M28,15h2A13.015,13.015,0,0,0,17,2V4A11.013,11.013,0,0,1,28,15Z" />
    </g>
  </svg>
);
