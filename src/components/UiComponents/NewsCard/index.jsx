  ...
  return (
    <div className="news-card bg-white rounded-lg  overflow-hidden">
      ...
      <div className="relative">
        ...
        />
        <button className="register-btn absolute top-4 left-4 bg-orange-500 text-white px-4 py-2 rounded-full">
          Register Now
        </button>
      </div>
      {/* Text Content */}
      <div className="p-4 flex flex-col flex-grow">
        ...
        <a
          href="#"
          className="read-more mt-4 inline-flex items-center text-blue-950"
        >
          Read More
          <svg
