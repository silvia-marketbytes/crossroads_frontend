...
import bannerImg from "../../../assets/FreeEducation/slovaniafree_result.webp";
...
const FreeEducationSlovania= () => {
  const bannerProps = {
    backgroundImage: bannerImg,
    title: "Free Education : Slovania",
          ...
          <div className="lg:w-1/2 w-full flex flex-col" style={{ backgroundColor: "#00334D" }}>
            ...
            >
              <h3 className="text-2xl sm:text-3xl font-l mt-16 mb-1 text-white">
                Want Free Education in Slovania?
              </h3>
  ...
  return (
    <div className="relative">
      ...
      <FeatureHighlightSection
        title="Launch Your Future with Free Education in Slovania"
        features={features}
      />
...
export default FreeEducationSlovania;
