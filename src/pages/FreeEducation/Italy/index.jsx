...
import bannerImg from "../../../assets/FreeEducation/Italyfree_result.webp";
import ContactSection from "../../../pages/Home/UiComponents/ContactSection";
import italyImage from "../../../assets/FreeEducation/BANNER PNG_result.webp";
  ...
  const WhyChooseSection = () => {
    ...
    const dropdownSections = [
      ...
      },
      {
        ...
        content:
          "For bachelor’s and master’s programs, deadlines vary by university, typically between April and July for the fall semester.",
      },
      {
      ...
      },
      {
        ...
        content:
          "Applicants must hold a high school diploma equivalent to the Italian Esame di Stato, recognized by the university.",
      },
    ];
          ...
          >
            ...
            >
              ...
              <p className="text-white mb-8">
                Italy offers world-class education with low or no tuition fees at
                public universities for international students, depending on
                family income and scholarships.
              </p>
  ...
  const features = [
    {
      ...
      description:
        "Students may qualify for low or no tuition fees based on family income, with scholarships available.",
    },
    {
      title: "A Global Student Hub",
      description:
        "Italy attracts thousands of international students, including many from India, with its rich cultural heritage and high-quality education.",
    },
    {
      title: "Investing in Tomorrow's Leaders",
      description:
        "Italy's affordable education model supports a future-ready, globally aware generation.",
    },
    {
      title: "Equal Access for All",
      description:
        "Regardless of where you're from, Italy promotes equal opportunities for academic success.",
    },
    {
      title: "World-Class Standards",
      description:
        "Italian universities maintain rigorous academic standards and a strong focus on excellence.",
    },
    {
  ...
  return (
    <div className="relative">
      ...
      <FeatureHighlightSection
        title="Launch Your Future with Free Education in Italy"
        features={features}
      />
...
export default FreeEducationItaly;