...
const FreeEducationGermany = () => {
          ...
          >
            ...
            >
              ...
              <p className="text-white mb-8">
                Germany offers world-class education with no tuition fees at public
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Germany attracts thousands of international students, including many from India, with its affordable, high-quality education.",
    },
    {
      title: "Investing in Tomorrow's Leaders",
      description:
        "The tuition-free model reflects Germany's commitment to building a future-ready, globally aware generation.",
    },
    {
      title: "Equal Access for All",
      description:
        "Regardless of where you're from, Germany ensures equal opportunities for academic success.",
    },
    {
      title: "World-Class Standards",
      description:
        "Free doesn't mean easy — German universities maintain rigorous academic standards and a strong focus on excellence.",
    },
    {
  ...
  return (
    <div className="relative">
      ...
      <FeatureHighlightSection
        title="Launch Your Future with Free Education in Germany"
        features={features}
      />
