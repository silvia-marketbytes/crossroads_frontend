          ...
          >
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold mt-16 mb-16 text-white">
                Why choose <span className="text-[#F9920A]">France?</span>
              </h2>
              <p className="text-white mb-8">
              Studying in France not only offers access to a world-class education but also provides the chance to immerse
