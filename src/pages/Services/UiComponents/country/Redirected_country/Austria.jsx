...
import bannerImg from "../../../../../assets/Contrydetailpagebanners/Austria_result.webp";
...
const Austria = () => {
  ...
  const countryDescription = `
    Austria, officially known as the Commonwealth of Austria, is a country in the Southern Hemisphere
    comprising the mainland of the Austrian continent, the island of Tasmania, and numerous smaller islands.
  ...
  const dropdownSections = [
    {
      ...
      content: "Austria is home to world-renowned universities offering high-quality education.",
    },
    {
    ...
    },
    {
      ...
      content: "Austria is a leader in innovation and research-driven education.",
    },
  ];
